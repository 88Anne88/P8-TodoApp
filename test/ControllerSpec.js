...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show completed entries', function () {
			...
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
			expect(model.read).toHaveBeenCalledWith({completed: true}, jasmine.any(Function)); //ADDED
		});
	});
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// DONE
			var todos= [{ id: 42, title: 'my todo1', completed: false},
			...
			expect(model.update).toHaveBeenCalledWith(todos[randomIdx].id, {completed: true}, jasmine.any(Function));
		});

		it('should update the view', function () {
			// DONE
			var todos= [{ id: 42, title: 'my todo1', completed: false},
				{id: 43 ,title: 'my todo2', completed: true}
			];
			setUpModel(todos);
			subject.setView('');
			view.trigger('toggleAll', {completed: false});
			expect(view.render).toHaveBeenCalledWith('toggleAll', {checked: false});
			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 42, completed: false}); //???  ADDED
		});
	});
